...
export default defineConfig(({ mode }: { mode?: string }) => {
  ...
  return {
    // Si tienes un nombre de repositorio en GitHub, cámbialo aquí abajo.
    // Ejemplo: '/mi-portafolio/' o usa el valor de FIGMA_PUBLIC_URL
...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "ExoticDev | Portafolio"
